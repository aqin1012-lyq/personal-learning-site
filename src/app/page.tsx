...
import { buildDeckSections, buildHomeStats, buildNotesHref, buildQuickMap, buildTimelineYears } from '@/lib/home';
...
export default function HomePage() {
  ...
  const stats = buildHomeStats(logs, notes, projects);
  const quickMap = buildQuickMap();
  const deckSections = buildDeckSections();
  const timelineYears = buildTimelineYears(logs, notes, projects);
          ...
          <SiteContainer className="space-y-10 py-8 md:space-y-12 md:py-12">
            <Hero
              ...
              quickChips={[
                ...
                { label: 'Demo Site', href: '/about' },
                { label: 'Practice', href: '/projects' },
              ]}
            />
