...
export function SearchBox({ placeholder = '搜索', value = '', onChange }: SearchBoxProps) {
  return (
    <label className="group block">
      <div className="relative overflow-hidden rounded-[20px] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.016))] transition duration-300 group-focus-within:border-[rgba(136,117,216,0.24)] group-focus-within:bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))]">
        <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-stone-500 transition group-focus-within:text-violet-200/80">⌕</div>
        <input
          type="text"
          value={value}
