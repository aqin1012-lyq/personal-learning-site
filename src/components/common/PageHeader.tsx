...
export function PageHeader({ title, description }: PageHeaderProps) {
  return (
    <section className="section-shell overflow-hidden">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(136,117,216,0.2)] to-transparent" />
      <div className="pointer-events-none absolute -right-12 top-0 h-36 w-36 rounded-full bg-[radial-gradient(circle,rgba(136,117,216,0.12),transparent_70%)] blur-3xl" />
