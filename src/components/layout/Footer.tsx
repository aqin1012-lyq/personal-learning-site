...
export function Footer() {
  return (
    <footer className="mt-16 border-t border-white/[0.08] bg-[#0b0c11]/70 backdrop-blur-xl">
      <SiteContainer className="grid gap-8 py-10 text-sm text-stone-500 md:grid-cols-[1.2fr_0.8fr] md:items-start">
        ...
        <div className="grid gap-3 md:justify-end">
          ...
          <Link href="/logs" className="hover:text-stone-100">
            学习日志
          </Link>
          <Link href="/notes" className="hover:text-stone-100">
            知识库
          </Link>
          <Link href="/projects" className="hover:text-stone-100">
            项目实践
          </Link>
        </div>
      </SiteContainer>
