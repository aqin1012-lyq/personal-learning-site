...
export function Hero({
  ...
  return (
    <InteractiveSurface as="section" className="hero-shell surface-card interactive-surface-strong overflow-hidden rounded-[30px] px-6 py-8 md:px-9 md:py-11 lg:px-12 lg:py-14">
      ...
      <div className="hero-content-shell relative grid gap-10 lg:grid-cols-[minmax(0,1.2fr)_320px] lg:items-end lg:gap-12">
        <div className="max-w-4xl space-y-8 md:space-y-9">
          <div className="space-y-6 md:space-y-7">
            <div className="hero-kicker hero-magnetic-chip">
            ...
            <div className="max-w-3xl space-y-4 md:space-y-5">
              ...
              <h1 className="hero-title hero-magnetic-title">
              ...
              <p className="hero-subtitle hero-magnetic-copy">{subtitle}</p>
            </div>

            <div className="hero-quote-shell hero-magnetic-panel">
        ...
        <div className="hero-stat-stack grid gap-3 self-stretch md:grid-cols-3 lg:grid-cols-1">
          {stats.map((stat) => (
            <div key={stat.label} className="hero-stat-card hero-magnetic-panel">
