    ...
    <section className="section-shell stagger-surface overflow-hidden">
      <div className="relative space-y-7">
        ...
        <div className="relative overflow-x-auto pb-3 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <div className="min-w-[1120px] pr-4 pt-14">
            <div className="pointer-events-none absolute left-0 right-0 top-[5.35rem] h-px bg-[linear-gradient(90deg,rgba(186,149,110,0.18),rgba(186,149,110,0.55),rgba(186,149,110,0.18))]" />
